define(function (require) { 
  ...
  GridDialog.prototype.init = function(columns, items, multi_selectable) {
  ...
  GridDialog.prototype.title = function(title_) {
    this._dialog.title(title_);
  };
  
  GridDialog.prototype.ok = function(callback) {
    this._ok = callback;
  };
  
  GridDialog.prototype.size = function(width, height) {
  ...
  GridDialog.prototype.close = function() {
    this._dialog.close();
  };
